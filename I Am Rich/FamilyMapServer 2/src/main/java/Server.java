...
/**
 * The server class implements all my server functionality
 * It implements a Http handlers for all the routes and send them to
 * specific handlers
 */
public class Server {
    ...
    private void run(String portNumber) {
        ...
        // forwards the request to the ServerPackage.handler for that URL path.
        ...
        // Create and install the HTTP ServerPackage.handler for the "/user/register" URL path.
        ...
        // Create and install the HTTP ServerPackage.handler for the "/user/login" URL path.
        // When the HttpServer receives an HTTP request containing the
    ...
    public static void main(String[] args) throws DataAccessException, FileNotFoundException {
